...
namespace Tests\Unit\Support {
    ...
    class VersionTest extends TestCase
    {
        ...
        {
            // NOTE: We are overriding the base_path function below to return "helper"
...
namespace App\Support {
    ...
    if (!function_exists('App\Support\base_path')) {
        /**
        ...
        {
            // NOTE: This also set in the SmokeScreenEndpointTest
